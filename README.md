...
When Knapsack Pro API is not available or temporarily not reachable due network problem then the Fallback Mode will be started and you will see a log warning in the output.
